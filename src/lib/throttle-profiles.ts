...
export const THROTTLE_PROFILES: ThrottleProfile[] = [
  ...
  },
  {
    ...
    maxConcurrency: 10,
    rollingWindowHours: 5,
    rollingWindowTurns: 1200, // 20x the Pro tier 5-hour rolling pool
    monthlyFastRequests: null,
    exhaustionBehavior: 'hard-block',
    slowQueueDelaySec: 0,
    evidenceQuote: '20x Pro 5-hour session burst headroom, but empirical telemetry (Faros AI / Morph) confirms weekly ceiling scales to only ~6x Pro before lockouts.',
    url: 'https://claude.com/pricing',
  },
  {
  ...
  },
  {
    ...
    rollingWindowTurns: 120, // Auto-refreshing daily/weekly quota
    monthlyFastRequests: null,
    exhaustionBehavior: 'slow-queue',
    slowQueueDelaySec: 20,
    evidenceQuote: 'Auto-refreshing daily and weekly quotas replacing legacy credit pool; soft fallback to standard model routing when consumed.',
    url: 'https://windsurf.com/pricing',
  },
  {
    id: 'openai-codex-pro5x',
    name: 'OpenAI Codex',
    category: 'coding-ide',
    tierName: 'Pro 5x',
    monthlyPrice: 100,
    maxConcurrency: 6,
    rollingWindowHours: 5,
    rollingWindowTurns: 250, // Observed ~$75 per 5h window (DevForth telemetry)
    monthlyFastRequests: null,
    exhaustionBehavior: 'hard-block',
    slowQueueDelaySec: 0,
    evidenceQuote: 'Observed limit windows: ~$75 per 5h and ~$350 per 7d across shared frontier reasoning models (DevForth telemetry).',
    url: 'https://openai.com/chatgpt/pricing/',
  },
  {
    id: 'openai-codex-pro20x',
    name: 'OpenAI Codex',
    category: 'coding-ide',
    tierName: 'Pro 20x',
    monthlyPrice: 200,
    maxConcurrency: 12,
    rollingWindowHours: 5,
    rollingWindowTurns: 1000, // Observed ~$400 per 5h window (DevForth telemetry)
    monthlyFastRequests: null,
    exhaustionBehavior: 'hard-block',
    slowQueueDelaySec: 0,
    evidenceQuote: 'Observed limit windows: ~$400 per 5h and ~$2,560 per 7d across shared models for high-concurrency loops (DevForth telemetry).',
    url: 'https://openai.com/chatgpt/pricing/',
  },
  {
    id: 'opencode-zen',
