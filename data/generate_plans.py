        ...
        "tiers": [
            {
                ...
                "models": ["Qwen 3.7 Plus", "Qwen 3.6 Plus", "Kimi K2.5", "GLM-5", "MiniMax M2.5"],
                "estimatedTokenBudget": {
        ...
        "tiers": [
            {
                ...
                "estimatedTokenBudget": {
                    ...
                    "assumptions": "Official Z.ai table (95% cache): 10,000 weekly credits = 48-97M GLM-5.3 tokens/week (146-292M GLM-5.3-Flash). Floor = all-peak (1x credit rate) 48M/wk x 4.33 wk = 208M/mo; ceiling = all off-peak (0.5x) 97M/wk x 4.33 = 420M/mo; midpoint 314M. Excludes the temporary GLM-5.3-Flash campaign bonus",
                    "estimateMeta": {
                        "sourceUrl": "https://docs.z.ai/devpack/overview",
                        "sourceQuote": "Estimated Token Allowance (95% cache): Lite GLM-5.3 48-97M tokens/week; off-peak usage charged at 50% of the standard credit rate",
                        "sourceType": "official",
                        "confidence": "high",
                        "verifiedAt": LAST_VERIFIED,
                        "basisModel": "GLM-5.3",
            ...
            },
            {
                ...
                "models": ["GLM-5.3", "GLM-5.3-Flash"],
                "estimatedTokenBudget": {
                    "description": "60K weekly credits; GLM-5.3 290-580M tokens/wk at 95% cache (official)",
                    "estimatedMillionTokens": 1256,
                    "midpointEstimate": 1884,
                    "optimisticEstimate": 2511,
                    "assumptions": "Official Z.ai table (95% cache): 60,000 weekly credits = 290-580M GLM-5.3 tokens/week (877M-1.76B GLM-5.3-Flash). Floor = all-peak 290M/wk x 4.33 = 1,256M/mo; ceiling = all off-peak 580M/wk x 4.33 = 2,511M/mo; midpoint 1,884M",
                    "estimateMeta": {
                        "sourceUrl": "https://docs.z.ai/devpack/overview",
                        "sourceQuote": "Estimated Token Allowance (95% cache): Pro GLM-5.3 290-580M tokens/week",
                        "sourceType": "official",
                        "confidence": "high",
                        "verifiedAt": LAST_VERIFIED,
                        "basisModel": "GLM-5.3",
            ...
            },
            {
                ...
                "models": ["GLM-5.3", "GLM-5.3-Flash"],
                "estimatedTokenBudget": {
                    "description": "140K weekly credits; GLM-5.3 676M-1.35B tokens/wk at 95% cache (official)",
                    "estimatedMillionTokens": 2927,
                    "midpointEstimate": 4391,
                    "optimisticEstimate": 5854,
                    "assumptions": "Official Z.ai table (95% cache): 140,000 weekly credits = 676M-1,352M GLM-5.3 tokens/week (2.05B-4.1B GLM-5.3-Flash). Floor = all-peak 676M/wk x 4.33 = 2,927M/mo; ceiling = all off-peak 1,352M/wk x 4.33 = 5,854M/mo; midpoint 4,391M",
                    "estimateMeta": {
                        "sourceUrl": "https://docs.z.ai/devpack/overview",
                        "sourceQuote": "Estimated Token Allowance (95% cache): Max GLM-5.3 676-1,352M tokens/week",
                        "sourceType": "official",
                        "confidence": "high",
                        "verifiedAt": LAST_VERIFIED,
                        "basisModel": "GLM-5.3",
